...
const getSuggest = (acc, fc) => {
  // if (acc === 100) return 'AP';
  // if (fc) return 'FC';
  // return 'Clear';
  return '还没写好';
};
...
const generateReport = async () => {
  ...
  try {
    const [playerData, summaryData, b27Data] = await Promise.all([
    ...
    const gameuser = {
      ...
      data: `${summaryData.EZ[1]}PB ${summaryData.HD[1]}GB ${summaryData.IN[1]}MB`,
    };
    ...
    b27Data.forEach((song, index) => {
      const transformedSong = {
        song: song.songName,
        illustration: `https://raw.githubusercontent.com/7aGiven/Phigros_Resource/refs/heads/illustrationBlur/${song.songId}.png`,
        rank: song.level,
